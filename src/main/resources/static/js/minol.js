$(function () {
  $("#fullpage").fullpage({
    ...
    onSlideLeave: function (
      ...
      $(".tab-progressive .bar span").css(
        "width",
        gagePoint[nextSlideIndex].toString()
      );
      $(".tab-progressive span.circle").css(
        "left",
        circlePoint[nextSlideIndex].toString()
      );
    },
  });
...
function popupWindow() {
  window.open(
    "terms.html",
    "popup",
    "width=400, height=500, left=0, top=0, scrollbars=no,titlebar=no,status=no,resizable=no,fullscreen=no"
  );
}
